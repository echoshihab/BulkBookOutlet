...
namespace BulkBookOutlet.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _unitOfWork.User.GetFirstOrDefault(c => c.Id == claim.Value,
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                    body: "Order Placed on Bulk Book Outlet. Your Order ID:" + id,
